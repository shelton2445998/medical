<template>
  <div class="container">
    <div class="form-box">
      <div class="form">
        <div class="sys-name mb30 flex-center"><img class="logo-img mr5" src="@/assets/logo.png" alt="">医生管理系统</div>
        <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules">
          <el-form-item class="mb25" prop="mobile">
            <el-input style="width: 300px" :prefix-icon="Iphone" clearable v-model="ruleForm.mobile" placeholder="请输入手机号"/>
          </el-form-item>
