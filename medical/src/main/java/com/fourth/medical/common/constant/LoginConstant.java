...
public interface LoginConstant {
     ...
     * boot.doctor.
     */
    String DOCTOR_TOKEN_PREFIX = TOKEN_PREFIX + "doctor.";
    ...
    /**
     * 医生端cookie token名称
     * boot.doctor.cookie.token
     */
    String DOCTOR_COOKIE_TOKEN_NAME = DOCTOR_TOKEN_PREFIX + COOKIE_PREFIX + TOKEN_NAME;

    String ADMIN_URL_PREFIX = "/admin";

    String APP_URL_PREFIX = "/app";

    String DOCTOR_URL_PREFIX = "/doctor";
    ...
    /**
     * doctor默认的token过期时间 120分钟
     */
    Integer DOCTOR_TOKEN_EXPIRE_MINUTES = 120;
