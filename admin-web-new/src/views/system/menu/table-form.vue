            ...
            <el-form-item prop="routeUrl" v-if="form.type !== 3">
              <template #label>
                <div class="label-tip align-center">
                  路由地址
                  <el-tooltip
                      content="前端访问的路由地址，以/开头，每个菜单的路由地址应唯一"
                      placement="top">
                    <el-icon>
                      <ele-question-filled/>
                    </el-icon>
            ...
            <el-form-item prop="componentPath">
              <template #label>
                <div class="label-tip align-center">
                  组件路径
                  <el-tooltip
                      content="前端vue代码中views目录下的文件路径，注意不用以/开头，如：system/user/index"
                      placement="top">
                    <el-icon>
                      <ele-question-filled/>
                    </el-icon>
            ...
            <el-form-item prop="code">
              <template #label>
                <div class="label-tip align-center">
                  权限标识
                  <el-tooltip
                      content="后端权限标识编码，如后端启用权限标识验证，则此处必填，对应后端@Permission中的编码值"
                      placement="top">
                    <el-icon>
                      <ele-question-filled/>
                    </el-icon>
            ...
            <el-form-item prop="sort">
              <template #label>
                <div class="label-tip align-center">
                  排序
                  <el-tooltip
                      content="在左侧导航菜单中显示的顺序，从低到高排序，默认为0"
                      placement="top">
                    <el-icon>
                      <ele-question-filled/>
                    </el-icon>
            ...
            <el-form-item prop="isShow">
              <template #label>
                <div class="label-tip align-center">
                  是否显示
                  <el-tooltip
                      content="是否在左侧导航栏菜单展示，默认显示，如选不显示，则只作为后台权限验证"
                      placement="top">
                    <el-icon>
                      <ele-question-filled/>
                    </el-icon>
