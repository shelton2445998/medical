...
<template>
  <el-card shadow="never" class="card-box">
    ...
    <!--    表格-->
    <el-table v-loading="tableLoading.status" :data="tableData.data" border style="width: 100%" row-key="id"
...
const getTableList = () => {
  ...
  getSysLogList({...pageData, ...queryForm.value, ...orderBy.value}).then(res => {
