...
/**
 * @fileoverview 科室表单页面
 * @description 提供科室的新增和编辑表单功能，包括表单验证、数据提交等
 * @author 医疗预约系统开发团队
 * @version 1.0.0
 * @created 2024-01-01
 * @features
      ...
      <el-row :gutter="10">
         <el-col :span="12">
           <el-form-item label="科室名称" prop="name">
             <el-input v-model="form.name" maxlength="50" placeholder="请输入科室名称"/>
           </el-form-item>
         </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="10">
         <el-col :span="12">
           <el-form-item label="描述" prop="description">
             <el-input v-model="form.description" maxlength="200" placeholder="请输入描述"/>
           </el-form-item>
         </el-col>
        <el-col :span="12">
...
import {addDepartment, getDepartment, updateDepartment} from "@/api/medical/department";
...
const openDialog = async (id: string) => {
  ...
  dialogData.title = '新增科室';
  if (id) {
    dialogData.id = id;
    dialogData.title = '编辑科室';
    getDetails(id);
  }
}
