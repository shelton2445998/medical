          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item prop="parentMenuId">
                ...
                <custom-tree-select v-model:value="form.parentMenuId" :options="state.menuList"
                                    placeholder="请选择上级菜单"/>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <el-form-item prop="idType">
                <template #label>
                  <div class="label-tip align-center">
                    主键策略
                    <el-tooltip content="配置主键ID生成策略，默认为ASSIGN_ID15位雪花算法ID，对应mybatisplus主键生成策略"
                                placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
            ...
            <el-col :span="12">
              <el-form-item prop="requestMappingStyle">
                <template #label>
                  <div class="label-tip align-center">
                    请求映射风格
                    <el-tooltip content="controller请求路径风格，默认为全名称路径，也可选择如restful风格等"
                                placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
            ...
            <el-col :span="12">
              <el-form-item prop="defaultOrderColumnName">
                <template #label>
                  <div class="label-tip align-center">
                    默认降序排列
                    <el-tooltip content="后台分页列表默认降序排列字段，默认为id降序，可输入如：create_time、update_time等"
                                placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
                ...
                <el-input v-model="form.defaultOrderColumnName"
                          placeholder="如id、create_time，如果为空，则不指定默认排序"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item prop="generatorBackend">
                <template #label>
                  <div class="label-tip align-center">
                    生成管理后端
                    <el-tooltip content="是否生成管理后台代码，默认生成，如选择否，则不会生成后端Java代码和菜单SQL"
                                placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
            ...
            <el-col :span="12">
              <el-form-item prop="generatorAppBackend">
                <template #label>
                  <div class="label-tip align-center">
                    生成App后端
                    <el-tooltip content="生成App后端的前提是生成后端选择是，默认生成，如不生成App接口代码，则选择否"
                                placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
            ...
            <el-col :span="12">
              <el-form-item prop="enablePermission">
                <template #label>
                  <div class="label-tip align-center">
                    启用权限编码
                    <el-tooltip content="是否在controller方法上添加@Permission权限编码注解，默认添加，如选择否，则不添加"
                                placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
              ...
              <el-form-item prop="generatorType">
                <template #label>
                  <div class="label-tip align-center">
                    生成方式
                    <el-tooltip
                        content="默认为下载zip文件，可修改为自定义路径，需要指定绝对路径，如不指定，默认为当前项目路径下"
                        placement="top">
                      <el-icon>
                        <ele-question-filled/>
                      </el-icon>
...
import {getAllSysMenuTreeList} from "@/api/menu";
...
const getGeneratorTable = async () => {
  const res = await getGeneratorTableApi(route.query.tableName as string);
