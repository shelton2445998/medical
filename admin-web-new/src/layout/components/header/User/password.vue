    ...
    <el-row class="user-box">
      <el-col>
        <el-form-item label="旧密码" prop="oldPassword">
          <el-input v-model="pswData.oldPassword" type="password" show-password="true" placeholder="请输入旧密码"/>
        </el-form-item>
      </el-col>
      <el-col>
        <el-form-item label="新密码" prop="password">
          <el-input v-model="pswData.password" type="password" show-password="true" placeholder="请输入新密码"/>
        </el-form-item>
      </el-col>
      <el-col>
        <el-form-item label="确认密码" prop="confirmPassword">
          <el-input v-model="pswData.confirmPassword" type="password" show-password="true" placeholder="请输入确认密码"/>
        </el-form-item>
      </el-col>
